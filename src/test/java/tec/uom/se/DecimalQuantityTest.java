...
public class DecimalQuantityTest {
    ...
    public void divideTest() {
        ...
        AbstractQuantity<Time> day = QuantityFactory.of(BigDecimal.TEN, SI.DAY);
    ...
    @Test
    public void addTest() {
        Quantity<Length> m = QuantityFactory.of(BigDecimal.TEN, SI.METRE);
    ...
    public void addQuantityTest() {
        Quantity<Time> day = QuantityFactory.of(BigDecimal.ONE, SI.DAY);
        Quantity<Time> hours = QuantityFactory.of(BigDecimal.valueOf(12), SI.HOUR);
    ...
    public void multiplyTest() {
        ...
        Quantity<Length> result2 = (Quantity<Length>) metre.multiply(QuantityFactory.of(BigDecimal.TEN, SI.METRE));
