...
/**
 * Extends <code>ResourceBundle</code> with 2 new capabilities. The first is to store the path where the
 * properties file used to create the <code>InputStream</code> is located and the second is to allow additional
 * <code>ResourceBundle</code> properties to be merged into an instance.
 * </p>
 * <p>
...
public class MultiPropertyResourceBundle extends ResourceBundle {
    ...
    /**
     * <p>
     * The location of the properties file that was used to instantiate the <code>MultiPropertyResourceBundle</code> instance.
    ...
    /**
     * @return The location of the properties file that was used to instantiate the <code>MultiPropertyResourceBundle</code>
     *         instance.
     */
    ...
    /**
     * <p>
     * A {@link StringBuilder} instance containing all the paths of the {@link ResourceBundle} instances that have been merged into
     * this instance. This value is intended to be use to help generate a key for caching JSON formatted resource output in the
     * {@link AbstractWebScript} class.
     * </p>
     */
    ...
    /**
     * <p>
     * Constructor for instantiating from an existing {@link ResourceBundle}. This calls the <code>merge</code> method to copy the
     * properties from the bundle into the <code>resources</code> map.
     * 
     * @param baseBundle
     * @param resourcePath
     */
    ...
    /**
     * <p>
     * Merges the properties of a <code>ResourceBundle</code> into the current <code>MultiPropertyResourceBundle</code>
